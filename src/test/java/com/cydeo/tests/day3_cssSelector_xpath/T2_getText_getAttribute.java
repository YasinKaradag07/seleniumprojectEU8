...
public class T2_getText_getAttribute {
    ...
    public static void main(String[] args) {
        ...
        if(actualRememberMeLabel.equals(expectedRememberMeLabel)){
            System.out.println("Remember me label message verification PASSED!");
        }else{
            System.out.println("Remember me label message verification FAILED!");
        }
...
Expected: Remember me on this computer 4- Verify “forgot password” link text is as expected:
