...
public class TestCase01 {
    ...
    public void Test1_1() {
        ...
        // Verify that home page is visible successfully : What they mean? --> Verify that you have Hope Page
        // URL and Title, another option verify that test cases button is displayed
    ...
    public void Test1_3(){
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//h2/b[.='Enter Account Information']")).isDisplayed(),
                "ENTER Account Details Fields Are NOT Displayed");
    }
